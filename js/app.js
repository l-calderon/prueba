$(document).ready(function() {
	...
	$('#ubigeo_dep option[value="14"]').attr("selected",true);
	$('#ubigeo_dep').trigger('change');
	
	//seleccionar por defecto LIMA
	$('#ubigeo_pro option[value="1406"]').attr("selected",true);
	$('#ubigeo_pro').trigger('change');
	
	//seleccionar por defecto ATE
	$('#ubigeo_dis option[value="140601"]').attr("selected",true);	
